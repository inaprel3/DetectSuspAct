# Кваліфікаційна робота бакалавра ("Розробка системи виявлення підозрілих активностей в комп’ютерних мережах", Цимбал Анастасія, 402)
## DetectSuspAct
...
Код написаний на основі програми LOGSHIELD. Сама програма буде допрацьована у майбутньому.
